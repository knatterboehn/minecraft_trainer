...
assert.match(metadata.artifactName, /blockcoach-client-0\.63\.0\+1\.21\.11\.jar/);
...
assert.match(install, /blockcoach-client-0\.63\.0\+1\.21\.11\.jar/);
...
assert.match(releaseChecklist, /v0\.63\.0-alpha/);
...
assert.match(readme, /Version 0.63/);
