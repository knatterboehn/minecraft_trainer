...
assert.match(metadata.artifactName, /blockcoach-client-0\.62\.0\+1\.21\.11\.jar/);
...
assert.match(install, /blockcoach-client-0\.62\.0\+1\.21\.11\.jar/);
...
assert.match(releaseChecklist, /v0\.62\.0-alpha/);
...
assert.match(readme, /Version 0.62/);
