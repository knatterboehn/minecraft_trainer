...
assert.match(metadata.artifactName, /blockcoach-client-0\.57\.0\+1\.21\.11\.jar/);
...
assert.equal(packageJson.version, '0.57.0');
...
assert.match(install, /blockcoach-client-0\.57\.0\+1\.21\.11\.jar/);
...
assert.match(releaseChecklist, /blockcoach-client-v0\.57\.0/);
...
assert.match(readme, /Version 0\.57/);
