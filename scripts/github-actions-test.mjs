...
assert.equal(metadata.artifactName, 'blockcoach-client-0.58.0+1.21.11.jar');
...
assert.match(workflow, /blockcoach-client-0\.58\.0-minecraft-1\.21\.11/);
...
assert.match(docs, /v0\.58 GitHub Actions Build/);
assert.match(docs, /Browser E2E checks/);
assert.match(docs, /\.github\/workflows\/fabric-build\.yml/);
assert.match(docs, /blockcoach-client-0\.58\.0-minecraft-1\.21\.11/);
assert.match(docs, /blockcoach-client-0\.58\.0\+1\.21\.11\.jar/);
