...
assert.match(releaseWorkflow, /blockcoach-client-0\.61\.0-minecraft-1\.21\.11/);
...
assert.match(buildWorkflow, /blockcoach-client-0\.61\.0-minecraft-1\.21\.11/);

assert.match(notes, /BlockCoach Client 0\.61\.0 Alpha/);
...
assert.match(actionsGuide, /git tag v0\.61\.0-alpha/);
